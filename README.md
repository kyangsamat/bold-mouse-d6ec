...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/bold-mouse-d6ec
```

A live public deployment of this template is available at [https://bold-mouse-d6ec.templates.workers.dev](https://bold-mouse-d6ec.templates.workers.dev)
